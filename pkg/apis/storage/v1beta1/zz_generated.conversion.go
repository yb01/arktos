...
func autoConvert_v1beta1_CSINodeSpec_To_storage_CSINodeSpec(in *v1beta1.CSINodeSpec, out *storage.CSINodeSpec, s conversion.Scope) error {
	if in.Drivers != nil {
		...
		*out = make([]storage.CSINodeDriver, len(*in))
		for i := range *in {
			if err := Convert_v1beta1_CSINodeDriver_To_storage_CSINodeDriver(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_storage_CSINodeSpec_To_v1beta1_CSINodeSpec(in *storage.CSINodeSpec, out *v1beta1.CSINodeSpec, s conversion.Scope) error {
	if in.Drivers != nil {
		in, out := &in.Drivers, &out.Drivers
		*out = make([]v1beta1.CSINodeDriver, len(*in))
		for i := range *in {
			if err := Convert_storage_CSINodeDriver_To_v1beta1_CSINodeDriver(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
