...
func (c *FakeCSINodes) Get(name string, options v1.GetOptions) (result *storagev1.CSINode, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewTenantGetAction(csinodesResource, name, c.te), &storagev1.CSINode{})
...
func (c *FakeCSINodes) List(opts v1.ListOptions) (result *storagev1.CSINodeList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewTenantListAction(csinodesResource, csinodesKind, opts, c.te), &storagev1.CSINodeList{})
...
func (c *FakeCSINodes) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewTenantWatchAction(csinodesResource, opts, c.te))
...
func (c *FakeCSINodes) Create(cSINode *storagev1.CSINode) (result *storagev1.CSINode, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewTenantCreateAction(csinodesResource, cSINode, c.te), &storagev1.CSINode{})
...
func (c *FakeCSINodes) Update(cSINode *storagev1.CSINode) (result *storagev1.CSINode, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewTenantUpdateAction(csinodesResource, cSINode, c.te), &storagev1.CSINode{})
...
func (c *FakeCSINodes) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewTenantDeleteAction(csinodesResource, name, c.te), &storagev1.CSINode{})
...
func (c *FakeCSINodes) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	...
	action := testing.NewTenantDeleteCollectionAction(csinodesResource, listOptions, c.te)
...
func (c *FakeCSINodes) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *storagev1.CSINode, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewTenantPatchSubresourceAction(csinodesResource, c.te, name, pt, data, subresources...), &storagev1.CSINode{})
